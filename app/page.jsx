		...
		<main className="home-page">
				...
				<div className="product-grid">
					<div className="product-1">
						<img
							...
							alt="product"
						/>
						<p className="product-name">Tropic 507 Ventair</p>
						<p className="product-price">$33.00</p>
					</div>
					<div className="product-2">
						...
						<p className="product-name">Monty&reg; Wool Beret</p>
						<p className="product-price">$33.00</p>
					</div>
			...
			<section className="iconic-shapes">
				...
				<div className="shapes-items">
					...
					<div className="shapes-wrapper shapes-1">
					...
					<div className="shapes-wrapper shapes-2">
						<div className="shapes-img-cont">
							<img
				...
				<div className="more-shapes">
					...
					<div className="shapes-img-cont more-1">
						<img
					...
					<div className="shapes-img-cont more-2">
						<img
			...
			<section className="clothing">
				...
				<div className="clothing-grid">
					<div className="cloth-img-wrapper cloth-1">
						<img
					...
					<div className="cloth-img-wrapper cloth-2">
						<img
					...
					<div className="cloth-img-wrapper cloth-3">
						<img
					...
					<div className="cloth-img-wrapper cloth-4">
						<img
